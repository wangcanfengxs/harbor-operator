...
// Delete
func (rc *RedisController) Delete(ctx context.Context, harborcluster *v1alpha2.HarborCluster) (*lcm.CRStatus, error) {
	return nil, fmt.Errorf("not implemented")
}

func (rc *RedisController) Upgrade(ctx context.Context, harborcluster *v1alpha2.HarborCluster) (*lcm.CRStatus, error) {
	return nil, fmt.Errorf("not implemented")
}
